    ...
    var Analyzer = /** @class */ (function () {
        ...
        Analyzer.prototype.startengine = function (name) {
            ...
            if (this.defaultengine == undefined) {
                this.log(new Misc.Logitem("no engine available"));
                return;
            }
            var em = new EngineMessage().
                _action("start").
                _name(name);
            this.connect(em, "engine");
        };
...
var ComboBox_ = /** @class */ (function (_super) {
    ...
    ComboBox_.prototype.setSelected = function (id) {
        this.options[id].setAttribute("selected", "true");
        return this;
    };
...
var GUI = /** @class */ (function () {
    ...
    GUI.prototype.stopenginebuttonpressed = function (e) {
        this.analyzer.stopanalysis();
        Globals.gui.tabs.setSelected("book");
    };
    GUI.prototype.restartenginebuttonpressed = function (e) {
        this.analyzer.startengine();
    };
...
(function (Globals) {
    ...
    Globals.startup = new TextAsset("startup.json?v3");
